...
-- CreateEnum
CREATE TYPE "StartOfWeek" AS ENUM ('MONDAY', 'SUNDAY');

-- CreateEnum
CREATE TYPE "StartupPage" AS ENUM ('DASHBOARD', 'CALENDAR', 'TASKS');
...
CREATE TABLE "UserSettings" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "startOfWeek" "StartOfWeek" NOT NULL DEFAULT 'MONDAY',
    "startupPage" "StartupPage" NOT NULL DEFAULT 'DASHBOARD',
